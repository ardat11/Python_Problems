...
#This means that in the Gregorian calendar, the years 2000 and 2400 are leap years, while 1800, 1900, and 2500 are NOT leap years.


def is_leap(year):
    leap = False

    if 1990 <= year <= 10 ** 5 and year % 4 == 0 and (year % 100 != 0 or year % 400 == 0):
        leap = True
